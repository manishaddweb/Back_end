...
<h2 align=center>FURNITURE</h2>

<table align=center style="border: 3px solid coral;" cellpadding=10 cellspacing=5>
<tr>
<th>PRO ID</th>
<th>CAT NAME</th>
<th>PRO NAME</th>
...
while($data=mysqli_fetch_array($query))
{
    ?>
        <tr>
            ...
            <div class="ml-5" style="margin-top:-24px;">
              <div class="ml-2">
                 <a href="delete_furniture.php?p_id=<?php echo $data['p_id'];?>" style="font-size:12px;background-color:red;padding:10px 15px;"> Delete</a>
              </div>
            </div>
			</td>
        </tr>
